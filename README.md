...
This is an easy-to-use GPU acceleration algorithm using CUDA, Numba, and CuPy. PLEASE make sure you have a GPU available to use, like NVIDIA or something that can run CUDA.
